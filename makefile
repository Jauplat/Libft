...
#    Updated: 2018/07/29 14:04:26 by jauplat          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILE = ft_bzero.c get_next_line.c ft_realloc.c\
		...
		ft_strnstr.c ft_strstr.c join_free.c njoin_free.c\
		ft_memcmp.c \
		...
		ft_atoi.c ft_itoa.c ft_itoa_base.c ft_isnegative.c \
